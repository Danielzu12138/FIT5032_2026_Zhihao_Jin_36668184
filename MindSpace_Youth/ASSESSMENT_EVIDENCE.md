...
| --- | --- |
| D.1 External authentication | Firebase Email/Password Authentication in `src/firebase.js` and `src/utils/auth.js`, including verified-email enforcement and password reset. |
